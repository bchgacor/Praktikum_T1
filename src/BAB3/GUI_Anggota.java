...
public class GUI_Anggota extends javax.swing.JFrame {
    ...
    private void btncetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetakActionPerformed
        ...
        gi.id_anggota = txtid.getText();
        gi.nama = txtnama.getText();
        gi.telp = txttelp.getText();
        output.append("ID Anggota : Rp." + gi.id_anggota +"\n");
        output.append("Nama Anggota : " + gi.nama + "\n");
        output.append("No Telp : " + gi.telp + "\n");
        output.append("--------------------------------------------------------\n");
